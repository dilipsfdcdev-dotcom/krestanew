...
export const metadata = {
  ...
  description:
    'A distinguished 100-acre farmland estate nestled amidst the majestic Rachakonda Hills. 600-900 plants per plot, 360° panoramic mountain views, gated community with world-class amenities. 30 km from ORR Exit 11.',
};
