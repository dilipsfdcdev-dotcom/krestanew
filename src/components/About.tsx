        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="section-title font-bold text-[#1a1a1a] mb-6">
              Crafting Luxury,
              <span className="text-[#1a4d2e]"> Building Dreams</span>
            </h2>
            ...
            <div className="space-y-6">
              {values.map((value, index) => (
                ...
                >
                  <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#1a4d2e]/10 flex items-center justify-center">
                    <value.icon className="w-5 h-5 text-[#1a4d2e]" />
                  </div>
                  <div>
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -bottom-4 right-20 w-16 h-16 bg-[#1a4d2e]/10 rounded-full" />
            </div>
          </motion.div>
        </div>
        ...
        >
          {stats.map((stat, index) => (
            ...
            >
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-[#1a4d2e] mb-2">{stat.number}</h3>
