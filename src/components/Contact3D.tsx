...
const contactInfo = [
  { icon: Phone, label: 'Phone', value: '+91-9888932555', href: 'tel:+919888932555' },
  { icon: Mail, label: 'Email', value: 'info@kresta.in', href: 'mailto:info@kresta.in' },
  { icon: MapPin, label: 'Office', value: '94, HIG, TV Colony, Vanasthalipuram, Hyderabad - 500070', href: 'https://maps.app.goo.gl/4HvLznBYEHfcQcHP7' },
...
export default function Contact3D() {
  ...
  return (
    <section id="contact" ref={sectionRef} className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,_rgba(201,169,98,0.05)_0%,_transparent_50%)]" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-8">
        ...
        >
          <p className="text-[#c9a962]/60 text-xs tracking-[0.3em] uppercase mb-4">Get In Touch</p>
          ...
          <p className="mt-4 text-white/40 max-w-xl mx-auto text-sm">
            Ready to own your piece of paradise? Reach out to us and let&apos;s discuss how we can help you find the perfect plot
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
              ...
              >
                {item.href ? (
                  <a
                    ...
                    className="group flex items-start gap-4 p-5 glass rounded-2xl hover:glass-gold transition-all duration-500"
                  >
                    ...
                    <div>
                      ...
                      <div className="text-white/70 text-sm group-hover:text-[#c9a962] transition-colors">{item.value}</div>
                    </div>
                  </a>
                ) : (
                  <div className="flex items-start gap-4 p-5 glass rounded-2xl">
                    <div className="flex-shrink-0 w-10 h-10 flex items-center justify-center rounded-xl bg-[#c9a962]/10">
                      <item.icon size={18} className="text-[#c9a962]" />
                    </div>
                    <div>
                      <div className="text-white/30 text-xs uppercase tracking-wider mb-1">{item.label}</div>
            ...
            >
              ...
              <p className="text-white/30 text-xs">Get instant replies to your queries</p>
              <div className="mt-4 inline-flex items-center gap-2 px-5 py-2.5 bg-[#25D366] text-white text-sm font-semibold rounded-full group-hover:bg-[#128C7E] transition-colors">
                Chat on WhatsApp
              </div>
            </motion.a>
            ...
            <motion.div
              ...
              className="rounded-2xl overflow-hidden glass h-48"
            >
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3808.1234!2d78.5579!3d17.3234!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTfCsDE5JzI0LjIiTiA3OMKwMzMnMjguNCJF!5e0!3m2!1sen!2sin!4v1234567890"
                width="100%"
                height="100%"
                style={{ border: 0, filter: 'grayscale(1) invert(0.9) contrast(0.8) opacity(0.5)' }}
                allowFullScreen
                loading="lazy"
          ...
          >
            <form onSubmit={handleSubmit} className="p-8 rounded-3xl glass space-y-5">
              ...
              <p className="text-white/30 text-xs mb-6">Fill in your details and we&apos;ll get back to you</p>
