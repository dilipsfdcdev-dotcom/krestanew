...
const quickLinks = [
  ...
  { name: 'Plant Forest', href: '#forest' },
  { name: 'Amenities', href: '#amenities' },
  { name: 'Contact', href: '#contact' },
];

const projectLinks = [
  { name: 'Plot Sizes', href: '#project' },
  { name: 'Location', href: '#project' },
  { name: 'Investment', href: '#project' },
...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0d2818] text-white relative overflow-hidden">
      {/* Decorative Elements */}
      <div className="absolute top-0 left-0 w-96 h-96 bg-[#c9a962]/5 rounded-full filter blur-[100px]" />
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-[#1a4d2e]/30 rounded-full filter blur-[100px]" />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 mb-16">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold">KRESTA</h3>
          ...
          {/* Project Links */}
          <div>
            <h4 className="font-semibold text-lg mb-6 text-white">The Meadow Breeze</h4>
            <ul className="space-y-3">
