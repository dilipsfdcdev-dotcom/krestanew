  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container-luxury text-center text-white">
        ...
        >
          Premium 50-acre farmland community nestled amidst the lush green hills of Rachakonda
        </motion.p>
      ...
      <div className="hidden lg:block absolute right-8 top-1/2 -translate-y-1/2">
        <div className="flex flex-col items-center gap-4">
          ...
          <a href="https://instagram.com" target="_blank" className="text-white/60 hover:text-[#c9a962] transition-colors">
