      ...
      <div className="container-luxury" ref={ref}>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div className={`reveal-left ${visible ? 'visible' : ''} space-y-4`}>
            <a href="tel:+919888932555" className="flex items-center gap-4 p-5 glass rounded-lg hover:border-[#d4af37]/20 transition-all group">
              <div className="w-12 h-12 bg-green-500/20 rounded flex items-center justify-center group-hover:bg-green-500/30 transition-colors"><Phone className="w-5 h-5 text-green-400" /></div>
              <div><p className="text-white/30 text-xs tracking-widest uppercase">Call Us</p><p className="text-white font-semibold">+91-9888932555</p></div>
            </a>
            <a href="mailto:info@kresta.in" className="flex items-center gap-4 p-5 glass rounded-lg hover:border-[#d4af37]/20 transition-all group">
              <div className="w-12 h-12 bg-blue-500/20 rounded flex items-center justify-center group-hover:bg-blue-500/30 transition-colors"><Mail className="w-5 h-5 text-blue-400" /></div>
              <div><p className="text-white/30 text-xs tracking-widest uppercase">Email Us</p><p className="text-white font-semibold">info@kresta.in</p></div>
            </a>
            <div className="flex items-center gap-4 p-5 glass rounded-lg">
              <div className="w-12 h-12 bg-red-500/20 rounded flex items-center justify-center"><MapPin className="w-5 h-5 text-red-400" /></div>
              <div><p className="text-white/30 text-xs tracking-widest uppercase">Office Address</p><p className="text-white/80 text-sm">94, HIG, TV Colony, Vanasthalipuram, Hyderabad - 500070</p></div>
            </div>

            <div className="p-6 bg-gradient-to-br from-[#25d366]/20 to-[#128c7e]/10 rounded-lg border border-[#25d366]/20">
              ...
              <a href="https://wa.me/919888932555?text=Hi%2C%20I%27m%20interested%20in%20The%20Meadow%20Breeze%20project.%20Please%20share%20more%20details." target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#25d366] text-white rounded text-sm font-medium hover:bg-[#128c7e] transition-colors">
                <MessageCircle className="w-4 h-4" />Chat on WhatsApp
              </a>
            </div>

            <a href="https://instagram.com/themeadowbreezebykresta" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-5 bg-gradient-to-br from-[#833ab4]/20 via-[#fd1d1d]/10 to-[#fcb045]/10 rounded-lg border border-white/5 hover:border-white/10 transition-all">
          ...
          <div className={`reveal-right ${visible ? 'visible' : ''}`}>
            <div className="glass rounded-lg p-8 md:p-10">
              <h3 className="text-xl font-bold text-white mb-8 font-[family-name:var(--font-heading)]">Request Information</h3>
              {isSubmitted ? (
