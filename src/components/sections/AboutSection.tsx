            ...
            return (
              <FadeInUp key={feature.title} delay={index * 0.1}>
                <div className="luxury-card text-center group hover:-translate-y-1">
                  <div className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-[#0a2515]/5 flex items-center justify-center group-hover:bg-[#0a2515] transition-colors duration-500">
                    <Icon className="w-7 h-7 text-[#d4a843]" />
                  </div>
                  <h3 className="text-xl font-bold text-[#0a2515] mb-3">
                    {feature.title}
                  </h3>
